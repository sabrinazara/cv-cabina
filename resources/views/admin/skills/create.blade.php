...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-center mb-6">
        ...
        <h2 class="text-3xl font-bold text-gray-800">Tambah Keahlian Baru</h2>
    </div>
            ...
            <form action="{{ route('admin.skills.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <span id="level-value" class="text-sm font-medium text-gray-700 min-w-[60px] text-center">{{ old('level', 50) }}%</span>
                    </div>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="4" 
                        ...
                        placeholder="Jelaskan keahlian ini...">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                ...
                <div class="flex items-center justify-end gap-4 pt-4">
                    ...
                    <button type="submit" 
                        class="bg-green-600 text-white px-6 py-2.5 rounded-lg hover:bg-green-700 transition duration-200 font-medium flex items-center gap-2">
