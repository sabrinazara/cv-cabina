...
<div class="container mx-auto px-4 py-8">
    <h2 class="text-3xl font-bold mb-6">Tambah Proyek Baru</h2>
    
    <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        ...
        <div class="mb-4">
            <label for="image" class="block text-gray-700 text-sm font-bold mb-2">Gambar Proyek</label>
